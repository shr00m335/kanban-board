...
const CreateProjectPopup = (): JSX.Element => {
  return (
    <div className="absolute top-0 left-0 w-screen h-screen bg-black/50 flex">
      <div className="w-3/5 h-3/5 bg-white m-auto relative p-4 rounded-xl">
        <IoClose
          className="absolute right-4 top-4 cursor-pointer hover:text-black/50"
          size={30}
        />
        ...
        <div className="flex w-min ml-auto mt-10">
          <button className="bg-blue-600 text-white w-40 mr-3 py-1 text-xl rounded-xl">
            Cancel
          </button>
          <button className="bg-blue-600 text-white w-40 py-1 text-xl rounded-xl">
            Create
          </button>
        </div>
      </div>
